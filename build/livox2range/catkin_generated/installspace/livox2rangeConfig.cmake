...
if(livox2range_CONFIG_INCLUDED)
  return()
endif()
set(livox2range_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(livox2range_SOURCE_PREFIX /home/chunran/livox2range/src/livox2range)
  set(livox2range_DEVEL_PREFIX /home/chunran/livox2range/devel)
  set(livox2range_INSTALL_PREFIX "")
  set(livox2range_PREFIX ${livox2range_DEVEL_PREFIX})
else()
  set(livox2range_SOURCE_PREFIX "")
  set(livox2range_DEVEL_PREFIX "")
  set(livox2range_INSTALL_PREFIX /home/chunran/livox2range/install)
  set(livox2range_PREFIX ${livox2range_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'livox2range' is deprecated")
...
set(livox2range_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "include;/usr/include/pcl-1.7;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/libxml2;/usr/include/python2.7;/usr/include/tcl " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${livox2range_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'livox2range' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'livox2range' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(livox2range_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND livox2range_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND livox2range_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT livox2range_NUM_DUMMY_TARGETS)
      set(livox2range_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::livox2range::wrapped-linker-option${livox2range_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR livox2range_NUM_DUMMY_TARGETS "${livox2range_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::livox2range::wrapped-linker-option${livox2range_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND livox2range_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(livox2range_LIBRARY_DIRS ${lib_path})
      list(APPEND livox2range_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'livox2range'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND livox2range_LIBRARIES ${lib})
    endif()
  endif()
...
set(livox2range_EXPORTED_TARGETS "livox2range_gencfg")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${livox2range_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 livox2range_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${livox2range_dep}_FOUND)
      find_package(${livox2range_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${livox2range_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(livox2range_INCLUDE_DIRS ${${livox2range_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(livox2range_LIBRARIES ${livox2range_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${livox2range_dep}_LIBRARIES})
  _list_append_deduplicate(livox2range_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(livox2range_LIBRARIES ${livox2range_LIBRARIES})

  _list_append_unique(livox2range_LIBRARY_DIRS ${${livox2range_dep}_LIBRARY_DIRS})
  list(APPEND livox2range_EXPORTED_TARGETS ${${livox2range_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${livox2range_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
