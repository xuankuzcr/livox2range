...
if(aiimooc_syz_CONFIG_INCLUDED)
  return()
endif()
set(aiimooc_syz_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(aiimooc_syz_SOURCE_PREFIX /home/chunran/livox2range/src/aiimooc_syz)
  set(aiimooc_syz_DEVEL_PREFIX /home/chunran/livox2range/devel)
  set(aiimooc_syz_INSTALL_PREFIX "")
  set(aiimooc_syz_PREFIX ${aiimooc_syz_DEVEL_PREFIX})
else()
  set(aiimooc_syz_SOURCE_PREFIX "")
  set(aiimooc_syz_DEVEL_PREFIX "")
  set(aiimooc_syz_INSTALL_PREFIX /home/chunran/livox2range/install)
  set(aiimooc_syz_PREFIX ${aiimooc_syz_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'aiimooc_syz' is deprecated")
...
set(aiimooc_syz_FOUND_CATKIN_PROJECT TRUE)

if(NOT "include;/usr/include/pcl-1.7;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/libxml2;/usr/include/python2.7;/usr/include/tcl " STREQUAL " ")
  set(aiimooc_syz_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/pcl-1.7;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/libxml2;/usr/include/python2.7;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 's <suyun_zheng@163.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${aiimooc_syz_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'aiimooc_syz' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'aiimooc_syz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
    _list_append_unique(aiimooc_syz_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND aiimooc_syz_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND aiimooc_syz_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT aiimooc_syz_NUM_DUMMY_TARGETS)
      set(aiimooc_syz_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::aiimooc_syz::wrapped-linker-option${aiimooc_syz_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR aiimooc_syz_NUM_DUMMY_TARGETS "${aiimooc_syz_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::aiimooc_syz::wrapped-linker-option${aiimooc_syz_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND aiimooc_syz_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/chunran/livox2range/install/lib;/home/chunran/catkin_ws/devel/lib;/home/chunran/livox_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(aiimooc_syz_LIBRARY_DIRS ${lib_path})
      list(APPEND aiimooc_syz_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'aiimooc_syz'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND aiimooc_syz_LIBRARIES ${lib})
    endif()
  endif()
...
set(aiimooc_syz_EXPORTED_TARGETS "aiimooc_syz_gencfg")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${aiimooc_syz_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;sensor_msgs;pcl_ros;cv_bridge;geometry_msgs;image_transport")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 aiimooc_syz_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${aiimooc_syz_dep}_FOUND)
      find_package(${aiimooc_syz_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${aiimooc_syz_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(aiimooc_syz_INCLUDE_DIRS ${${aiimooc_syz_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(aiimooc_syz_LIBRARIES ${aiimooc_syz_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${aiimooc_syz_dep}_LIBRARIES})
  _list_append_deduplicate(aiimooc_syz_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(aiimooc_syz_LIBRARIES ${aiimooc_syz_LIBRARIES})

  _list_append_unique(aiimooc_syz_LIBRARY_DIRS ${${aiimooc_syz_dep}_LIBRARY_DIRS})
  list(APPEND aiimooc_syz_EXPORTED_TARGETS ${${aiimooc_syz_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${aiimooc_syz_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
